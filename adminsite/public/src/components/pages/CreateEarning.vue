	        ...
	        <div class="col-md-12">
	        	<div class="card">
		        	...
		        	<div class="card-footer">
		        		<button class="btn btn-primary" v-on:click="onCreateEarning">
		        			Create Earning
...
export default {
	...
	methods: {
		onCreateEarning: function() {
            ...
            this.$validator.validateAll('earning-form').then(()=>{
                ...
                this.$socket.emit("earning/createEarning", this.earning)
            }).catch(()=>{
	...
	sockets: {
		"earning/createEarning": function(val) {
			console.log(val)
			var createdEarning = val.body.data
